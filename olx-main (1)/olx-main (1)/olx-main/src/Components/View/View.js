      ...
      <div className="rightSection">
        ...
        {userDetails &&
          <div className="contactDetails">
            {user ? (
              <><p className="p-bold">Seller details</p><p>Name : {userDetails.name}</p><p>Phone : {userDetails.phone}</p></>
            ) : (
              <><p className="p-bold">Seller details</p><p><Link to="/login"><span>Login</span></Link> First to view seller details.</p></>
            )}
